    ...
    stages: [
        {
            ...
            weeks: [
                {
                    days: [{ type: mongoose_1.Schema.Types.Mixed }], // Can be string ('Rest Day') or object (Workout)
                },
            ],
        },
    ],
...
exports.WorkoutPlan = mongoose_1.default.models.WorkoutPlan || mongoose_1.default.model('WorkoutPlan', WorkoutPlanSchema);
