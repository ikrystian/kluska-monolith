...
const CustomProductSchema = new mongoose_1.Schema({
...
const CustomProduct = mongoose_1.default.models.CustomProduct || mongoose_1.default.model('CustomProduct', CustomProductSchema);
