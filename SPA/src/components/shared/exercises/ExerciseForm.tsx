...
const exerciseSchema = z.object({
    ...
    type: z.enum(['weight', 'duration', 'reps']).optional(),
...
export function ExerciseFormDialog({
    ...
    const handleGenerateImage = async () => {
        ...
        if (!exerciseName) {
            toast.error("Wprowadź najpierw nazwę ćwiczenia.");
            return;
        }
        try {
            ...
            toast.success("Obrazek został wygenerowany.");
        } catch {
                                    ...
                                    <TabsContent value="upload" className="mt-3">
                                        <div className="text-center p-4 border-2 border-dashed rounded-lg">
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Funkcja przesyłania plików będzie dostępna wkrótce.
                                            </p>
                                            <p className="text-xs text-muted-foreground mt-1">
                                                Użyj zakładki URL, aby dodać obrazek.
                                            </p>
                                        </div>
                                    </TabsContent>
